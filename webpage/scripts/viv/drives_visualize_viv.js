...
function drivesTimerCallback() {
  ...
  if(drive_printing) {
    try
    {
      document.getElementById("drive_1").innerHTML = Math.round(current_velocities[0] * 100) / 100 + " °/s";
      document.getElementById("drive_2").innerHTML = Math.round(current_velocities[1] * 100) / 100 + " °/s";
      document.getElementById("drive_3").innerHTML = Math.round(current_velocities[2] * 100) / 100 + " °/s";
      document.getElementById("drive_4").innerHTML = Math.round(current_velocities[3] * 100) / 100 + " °/s";
    }
    catch
    {
      console.log("drives_visualize_viv.js ERR");  
